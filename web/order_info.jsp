...
<div class="container">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${order.orderItems}" var="orderItem">
                    ...
                    <tr class="active">
                        ...
                        <td width="30%"><a target="_blank"> 有${orderItem.product.pname}</a></td>
    ...
    <div>
        <hr/>
        <form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath}/order" method="post"
